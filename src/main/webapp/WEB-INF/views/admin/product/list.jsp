...
<c:url var="formUrl" value="/admin/product/list"/>
                                    ...
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            <a flag="info" class="dt-button buttons-colvis btn btn-white btn-primary btn-bold"
                                               data-toggle="tooltip" title="Thêm bài viết mới" href='<c:url value="/admin/product/edit"/>'>
                                                    <span>
                                ...
                                <div class="table-responsive">
                                    <display:table name="model.listResult" cellspacing="0" cellpadding="0"
                                        ...
                                        <display:column headerClass="col-actions" title="Thao tác">
                                            <c:url var="editPost" value="/admin/product/edit">
    ...
    function deleteProduct(data) {
        $.ajax({
            ...
            success: function(res) {
                window.location.href = "<c:url value='/admin/product/list?message=delete_success'/>";
            },
            error: function(res) {
                console.log(res);
