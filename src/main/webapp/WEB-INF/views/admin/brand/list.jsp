...
<c:url var="formUrl" value="/admin/brand/list"/>
<c:url var="brandAPI" value="/api/admin/brand"/>
                                    ...
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            <a flag="info" class="dt-button buttons-colvis btn btn-white btn-primary btn-bold"
                                               data-toggle="tooltip" title="Thêm thương hiệu" href='<c:url value="/admin/brand/edit"/>'>
                                                    <span>
                                                    <i class="fa fa-plus-circle bigger-110 purple"></i>
                                                </span>
                                            </a>
                                            <button id="btnDelete" type="button" class="dt-button buttons-html5 btn btn-white btn-primary btn-bold"
                                                    data-toggle="tooltip" title="Xóa thương hiệu" onclick="warningBeforeDelete()">
                                                    <span>
    ...
    function deleteBrand(data) {
        $.ajax({
            ...
            success: function(res) {
                window.location.href = "<c:url value='/admin/brand/list?message=delete_success'/>";
            },
            error: function(res) {
                console.log(res);
                window.location.href = "<c:url value='/admin/brand/list?message=error_system'/>";
            }
        });
    }
</script>
